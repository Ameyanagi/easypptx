...
class TestTable:
    ...
    def test_add_table_first_row_header(self):
        ...
        result = self.table.add(self.sample_data, first_row_header=True)
    ...
    def test_add_table_with_style(self):
        ...
        result = self.table.add(self.sample_data, style=5)
    ...
    def test_from_dataframe_basic(self):
        ...
        with patch.object(self.table, "add") as mock_add:
            # Call from_dataframe
            result = self.table.from_dataframe(df)
            
            # Verify add was called with correct data
            expected_data = [["A", "B"], [1, 3], [2, 4]]
    ...
    def test_from_dataframe_with_index(self):
        ...
        with patch.object(self.table, "add") as mock_add:
            ...
            result = self.table.from_dataframe(df, include_index=True)
    ...
    def test_from_dataframe_with_parameters(self):
        ...
        with patch.object(self.table, "add") as mock_add:
            ...
            result = self.table.from_dataframe(
                df,
                x=2.0,
                y=3.0,
                width=6.0,
