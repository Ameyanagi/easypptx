...
class TestImage:
    ...
    def test_add_image_with_dimensions(self):
        ...
        result = self.image.add(
            self.test_image_path, width=4.0, height=3.0, maintain_aspect_ratio=False
        )
    ...
    def test_add_image_maintain_aspect_ratio_width(self):
        ...
        result = self.image.add(
            self.test_image_path, width=4.0, maintain_aspect_ratio=True
        )
    ...
    def test_add_image_maintain_aspect_ratio_height(self):
        ...
        result = self.image.add(
            self.test_image_path, height=2.0, maintain_aspect_ratio=True
        )
