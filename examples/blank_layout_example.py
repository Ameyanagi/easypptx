...
from easypptx import Presentation, Text, Image
...
def create_from_template():
    ...
    if template_files:
        ...
        text.add_paragraph(
            f"This presentation uses {template_path.name} as a template",
            y="30%",
            font_size=24,
            color="blue"
        )
        ...
        try:
            ...
            text.add_paragraph(
                "Layout index 2 not available, using blank layout instead",
                y="40%",
                font_size=24,
                color="red"
            )
