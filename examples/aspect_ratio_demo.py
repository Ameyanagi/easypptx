...
def create_positioning_demo(aspect_ratio, output_filename):
    ...
    pres.add_title_slide(
        title=f"Aspect Ratio: {aspect_ratio}",
        subtitle="Demonstrating positioning with different aspect ratios"
    )
    ...
    section_slide = pres.add_section_slide("Full Width Section Slide")
