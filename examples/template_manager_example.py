...
title_slide = pres.add_title_slide(
    title="Template Manager Example",
    subtitle="Creating and using custom templates"
)
...
section_slide = pres2.add_section_slide(
    title="Direct Template Manager Integration",
    bg_color="darkblue"
)
